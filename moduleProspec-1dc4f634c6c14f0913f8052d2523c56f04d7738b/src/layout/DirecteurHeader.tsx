// src/layout/DirecteurHeader.tsx
...
import { DirecteurUserNav } from './DirecteurUserNav';

const DirecteurHeader = () => {
        ...
        <div className="lg:hidden">
          <Sheet open={isSheetOpen} onOpenChange={setIsSheetOpen}>
            ...
            <SheetContent side="left" className="w-[250px] p-0 bg-white">
              ...
              <div className="py-4">
                <DirecteurNavContent isCollapsed={false} onLinkClick={() => setIsSheetOpen(false)} />
              </div>
            </SheetContent>
          </Sheet>
        </div>
