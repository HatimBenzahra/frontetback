...
import { exportsService, ExportFormat, ExportResource } from '@/services/exports.service';
...
import { equipeService, EquipeFromApi } from '@/services/equipe.service';
import { zoneService, ZoneFromApi } from '@/services/zone.service';
...
const onDownload = async () => {
  ...
  try {
    ...
    if (resource === 'transcriptions') {
      ...
      await exportsService.download(params);
      return;
    }
