...
import { ManagerUserNav } from './ManagerUserNav';
...
const ManagerHeader = () => {
  ...
  return (
    <header className="sticky top-0 z-10 flex h-16 items-center justify-between gap-4 border-b border-b-[hsl(var(--winvest-green-moyen))] bg-[hsl(var(--winvest-green-moyen))] px-4 text-white sm:px-6">
      ...
      <div className="flex items-center gap-4">
        <div className="lg:hidden">
          <Sheet open={isSheetOpen} onOpenChange={setIsSheetOpen}>
            ...
            <SheetContent side="left" className="w-[250px] p-0 bg-white">
              ...
              <div className="py-4">
                <ManagerNavContent isCollapsed={false} onLinkClick={() => setIsSheetOpen(false)} />
              </div>
            </SheetContent>
          </Sheet>
        </div>
        ...
        {/* Titre mobile */}
        <h1 className="text-xl md:text-2xl font-bold md:hidden">Espace Manager</h1>
      </div>
