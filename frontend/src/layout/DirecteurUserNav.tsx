// src/layout/DirecteurUserNav.tsx
...
export function DirecteurUserNav() {
  ...
  const displayName = user.name || user.email || 'Directeur';
        ...
        <DropdownMenuLabel className="font-normal">
          <div className="flex flex-col space-y-1">
            ...
            <p className="text-xs leading-none text-muted-foreground">
              Directeur - {user.email || 'directeur@winvest.capital'}
            </p>
          </div>
        </DropdownMenuLabel>
        <DropdownMenuSeparator />
